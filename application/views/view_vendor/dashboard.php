                                        ...
                                        <form action="#">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <label
                                                            class="login2 pull-right pull-right-pro">Placeholder</label>
                                                    </div>
                                                    <div class="col-lg-9">
                                                        <input type="text" class="form-control"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-9 col-sm-9 col-xs-9">
                                                        <label class="login2 pull-right pull-right-pro"><span
                                                                class="basic-ds-n">Bootstrap</span> Default
                                                            Checkbox</label>
                                                    </div>
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-6 col-sm-8 col-xs-6">
                                                        <label class="login2 pull-right pull-right-pro">Inline <span
                                                                class="basic-ds-n">Checkbox</span>
                                                        </label>
                                                    </div>
                                                    <div class="col-lg-9 col-md-6 col-sm-4 col-xs-6">
                                                        <div class="bt-df-checkbox pull-left">
                                                            <label>
                                                                <input class="pull-left radio-checked" checked=""
                                                                    type="checkbox"> a</label>
                                                            <label>
                                                                <input class="pull-left radio-checked" type="checkbox">
                                                                b</label>
                                                            <label>
                                                                <input class="pull-left radio-checked" type="checkbox">
                                                                c</label>
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                                        <label class="login2 pull-right pull-right-pro">Custom Checkbox
                                                            and Radios </label>
                                                    </div>
                                                                    ...
                                                                    <div class="i-checks pull-left">
                                                                        <label>
                                                                            <input type="checkbox" value="" disabled=""
                                                                                checked=""> <i></i> <span
                                                                                class="basic-ds-n">Option</span> Three
                                                        ...
                                                        <div class="inline-checkbox-cs">
                                                            <label class="checkbox-inline i-checks pull-left">
                                                                <input type="checkbox" value="option1"
                                                                    id="inlineCheckbox1"> a </label>
                                                            <label class="checkbox-inline i-checks pull-left">
                                                                <input type="checkbox" value="option2"
                                                                    id="inlineCheckbox2"> b </label>
                                                            <label class="checkbox-inline i-checks pull-left">
                                                                <input type="checkbox" value="option3"
                                                                    id="inlineCheckbox3"> c </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group-inner input-with-success">
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <label class="login2 pull-right pull-right-pro">Input with
                                                            success</label>
                                                    </div>
                                                    <div class="col-lg-9">
                                                        <div class="form-select-list">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <label class="login2 pull-right pull-right-pro">Input Sizing
                                                            Lg</label>
                                                    </div>
                                                    <div class="col-lg-9">
                                                        <div class="form-select-list">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <label class="login2 pull-right pull-right-pro">Input Sizing Sm
                                                        </label>
                                                    </div>
                                                    <div class="col-lg-9">
                                                        <div class="form-select-list">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <div class="row">
                                                            <div class="col-lg-2">
                                                                <div class="form-select-list">
                                                                    <input type="text"
                                                                        class="form-control basic-ele-mg-b-10"
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                        <label class="login2 pull-right pull-right-pro">Input groups
                                                            @</label>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="input-group custom-go-button">
                                                            <span class="input-group-btn"><button type="button"
                                                                    class="btn btn-primary">Go!</button></span>
                                                            <input type="text" placeholder=".custom-go-button"
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                        <label class="login2 pull-right pull-right-pro">Input With left
                                                            dropdowns Custom</label>
                                                    </div>
                                                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" placeholder=".custom-dropdowns-button"
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                        <label class="login2 pull-right pull-right-pro">Input With right
                                                            dropdowns Custom</label>
                                                    </div>
                                                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="input-group">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                        <label class="login2 pull-right pull-right-pro">Input Segmented
                                                            Default</label>
                                                    </div>
                                                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="input-group">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                        <label class="login2 pull-right pull-right-pro">Input Left
                                                            Segmented</label>
                                                    </div>
                                                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="input-group">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                        <label class="login2 pull-right pull-right-pro">Input right
                                                            Segmented</label>
                                                    </div>
                                                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="input-group">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                        <label class="login2 pull-right pull-right-pro">File Upload
                                                            System Left</label>
                                                    </div>
                                                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
